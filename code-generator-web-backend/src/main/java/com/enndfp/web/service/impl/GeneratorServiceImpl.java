package com.enndfp.web.service.impl;
...
public class GeneratorServiceImpl extends ServiceImpl<GeneratorMapper, Generator> implements GeneratorService {
    ...
    public QueryWrapper<Generator> getQueryWrapper(GeneratorQueryRequest generatorQueryRequest) {
        ...
        Integer versionControl = generatorQueryRequest.getVersionControl();
        Integer forcedInteractive = generatorQueryRequest.getForcedInteractive();
        ...
        queryWrapper.eq(ObjectUtils.isNotEmpty(versionControl), "versionControl", versionControl);
        queryWrapper.eq(ObjectUtils.isNotEmpty(forcedInteractive), "forcedInteractive", forcedInteractive);
